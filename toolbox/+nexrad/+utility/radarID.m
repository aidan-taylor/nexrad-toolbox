classdef radarID < int16
	...
	methods
		function out = categories(radarID)
			%CATEGORIES
			%
			
			out = categorical(radarID.list);
		end
		
		function out = list(radarID)
			%LIST
			%
			
			out = string(enumeration(radarID))';
		end
		...
		function out = location(radarID)
			...
			locations = radarID.locations;
			out = locations.(char(radarID));
		end
	end
