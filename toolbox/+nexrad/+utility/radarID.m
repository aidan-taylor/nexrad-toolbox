classdef radarID < uint8
	...
	methods (Static)
		...
		function out = categories()
		out = categories(nexrad.utility.radarID.list);
		end
		
		function out = list()
		out = string(enumeration('nexrad.utility.radarID'))';
		end
		
		function out = location(radarID)
		locations = nexrad.utility.radarID.locations;
		out = locations.(radarID);
		end
		function out = locations()
		
		% RadarID	|	Latitude	|	Longitude	|	Elevation (ft)
		out = struct(...
